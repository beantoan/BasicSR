...
# configurations
img_folder = '/home/beantoan/task2/data/train/DIV2K_train_HR/*'  # glob matching pattern
lmdb_save_path = '/home/beantoan/task2/data/train/DIV2K_train_HR.lmdb'  # must end with .lmdb
